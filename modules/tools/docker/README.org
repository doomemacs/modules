...
[[pkg:docker-tramp]] offers [[https://www.gnu.org/software/tramp/][TRAMP]] support for Docker containers.
...
- =dockfmt= for [[module::editor format]]: https://github.com/jessfraz/dockfmt#installation
