...
(use-package! editorconfig
  ...
  ;; Fix doomemacs/core#5057 archives don't need editorconfig settings, and they
  ;; may otherwise interfere with the process of opening them (office formats
  ;; are zipped XML formats).
