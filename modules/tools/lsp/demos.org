...
(set-eglot-client! 'python-mode
  `(,(doom-profile-data-dir t \"lsp/mspyls/Microsoft.Python.LanguageServer\")))

;; This is equivalent to
(with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs `(python-mode . (,(doom-profile-data-dir t "lsp/mspyls/Microsoft.Python.LanguageServer\")))))
#+end_src
