...
- +peek ::
  ...
  from the [[doom-module::tools lookup]] module.

** Packages
- if [[doom-module:+eglot][+eglot]]
  - [[doom-package:eglot]]
  - [[doom-package:jsonrpc]]
  - [[doom-package:consult-eglot]] if [[doom-module::completion vertico][:completion vertico]]
  - [[doom-package:flycheck-eglot]] if [[doom-module::checkers syntax -flymake][:checkers syntax -flymake]]
  - [[doom-package:eglot-booster]] if [[doom-module:+booster]] and Emacs<30
- if [[doom-module:-eglot]]
  - [[doom-package:lsp-mode]]
  - [[doom-package:lsp-ui]]
  - [[doom-package:lsp-ivy]] if [[doom-module::completion ivy]]
  - [[doom-package:helm-lsp]] if [[doom-module::completion helm]]
  - [[doom-package:consult-lsp]] if [[doom-module::completion vertico]]
