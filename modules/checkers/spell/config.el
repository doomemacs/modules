...
(static-if (modulep! -flyspell)
    ...
    (use-package! spell-fu
      ...
      (setq spell-fu-directory (doom-profile-data-dir t "spell-fu"))
...
e.g. proselint and langtool."
  ...
  (use-package! flyspell-lazy
    ...
    ;; Fix doomemacs/core#3357: flyspell-lazy inhibits flyspell entirely in
    ;; message-mode derivatives (e.g. for notmuch users).
