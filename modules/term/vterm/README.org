# -*- doom-docs -*-
#+title:    :term vterm
#+subtitle: Almost the best terminal emulation in Emacs
...
#+begin_quote aside
[[pkg:vterm]] is as good as terminal emulation gets in Emacs (at the time of writing)
and the most performant, as it is implemented in C. However, it requires extra
steps to set up.
#+end_quote
