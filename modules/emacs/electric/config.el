...
(use-package! electric
  ...
  ;; Fix doomemacs/core#5051: Ensure electric-quote's handler runs before
  ;; smartparens' on `post-self-insert-hook', so that
  ;; `electric-quote-inhibit-functions' (e.g. `org-in-src-block-p') is respected
  ;; in org src blocks.
