...
built-in file manager for Emacs), powered by [[pkg:dirvish][Dirvish]].
...
- =poppler= (or [[module::tools pdf-tools]]) for pdf previews,
...
| [[kbd:][C-c C-e]] | Rename entries with [[pkg:wdired]]              |
