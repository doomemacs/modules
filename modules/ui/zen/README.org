...
modes from other editors — or [[doom-package:olivetti]], [[doom-package:sublimity]], and
[[doom-package:tabula-rasa]] (Emacs plugins) — will feel right at home.
...
- +focus ::
  ...
  working on. Includes LSP support if [[doom-module::tools lsp]] is enabled (without
  Eglot).

** Packages
- [[doom-package:mixed-pitch]]
- [[doom-package:writeroom-mode]]
- if [[doom-module:+focus]]
  - [[doom-package:focus]]
