...
** A custom banner
To use a custom image as your banner, change var:fancy-splash-image:
...
banner, replace func:+dashboard-widget-banner in var:+dashboard-functions with a
function that inserts your new banner into the current file.
#+end_quote

** Adding text to the dashboard
Doom's dashboard iterates over var:+dashboard-functions when it is told to
