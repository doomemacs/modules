...
- [[fns:diff-hl-revert-hunk]] displays a preview popup of the hunk being reverted.
  It takes up ~50% of the frame, by default, whether you're reverting 2 lines
  or 20. Since this isn't easily customized, it has been advised to shrink this
  popup to the side of its contents.
- [[fns:diff-hl-revert-hunk]] will sometimes move the cursor to an unexpected
...
- Any of Git, Svn, Hg, and/or Bazaar to get gutter diffs in version controlled
  projects.
- The GNU variant of ~diff~
