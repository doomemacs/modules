...
* Description :unfold:
This module turns Emacs into an email client using [[pkg:notmuch]].
...
- +org ::
  Enable [[pkg:org-mime]] for writing HTML emails using org-mode.

** Packages
- [[package:counsel-notmuch]] if [[module::completion ivy]]
- [[package:helm-notmuch]] if [[module::completion helm]]
- [[package:notmuch]]
- [[package:org-mime]]* if [[module:+org]]
