...
- [[doom-package:evil-nerd-commenter]]
...
| ~:sclear~                | ([[doom-module::ui workspaces]]) Kill all workspaces                                   |
| ~:sl[oad]~               | ([[doom-module::ui workspaces]]) Load the last saved session                           |
...
| ~:tabprev~               | ([[doom-module::ui workspaces]]) Switch to previous workspace                          |
| ~:tabr[ename]~ NAME      | ([[doom-module::ui workspaces]]) Rename the current workspace to NAME                  |
| ~:tabs~                  | ([[doom-module::ui workspaces]]) Display all workspaces in the echo area               |
| ~:tabsave [NAME]~        | ([[doom-module::ui workspaces]]) Save the selected workspace to file                   |
