...
* Description :unfold:
This module adds file templates for blank files, powered by [[pkg:yasnippet]].
...
#+begin_quote tip
Licenses with a ~-bp~ suffix are boilerplate templates; i.e. shorter versions
intended for comment headers in code files.
#+end_quote
