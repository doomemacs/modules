...
** Packages
- [[package:lispy]]
- [[package:lispyville]] if [[module::editor evil +everywhere]]
...
If [[module::editor evil]] is enabled, [[pkg:lispyville]] would also be activated for every mode
where [[pkg:lispy]] is active.
...
** Mouse wheel and =wrap=/=additional-wrap= key themes in TTY Emacs ([[https://github.com/doomemacs/core/issues/2573][#2573]])
