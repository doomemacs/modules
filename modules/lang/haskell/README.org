...
** Module flags
- +lsp ::
  Enable LSP support for ~haskell-mode~. Requires [[module::tools lsp]] and a langserver
...
- [[package:haskell-ts-mode]] if [[module:+tree-sitter]]
- [[package:lsp-haskell]] if [[module:+lsp]]
...
[[module::editor format]] by default uses [[https://github.com/fourmolu/fourmolu#installation][fourmolu]] to format code when not
