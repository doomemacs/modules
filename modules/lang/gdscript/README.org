...
engine, to Doom Emacs, powered by [[https://github.com/GDQuest/emacs-gdscript-mode][gdscript-mode]] and [[https://github.com/bbbscarter/gdshader-mode][gdshader-mode]].
...
** Module flags
- +lsp ::
  Enable LSP support for ~gdscript-mode~. Requires [[module::tools lsp]] and a langserver
...
you have [[module:+lsp]] and [[module::tools lsp]] enabled, and Godot 3.2.1+ installed, it should work
out of the box.
...
- The GDScript language server has known issues causing some errors with
  [[pkg:lsp-mode]]. They should be addressed in future releases.
