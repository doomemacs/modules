...
- Local schema viewer
- Org-babel exporter (requires [[module::lang org]])
...
** Module flags
- +lsp ::
  Enable LSP support for ~graphql-mode~. Requires [[module::tools lsp]] and a langserver
...
** Packages
- [[package:company-graphql]] unless [[module:+lsp]]
- [[package:graphql-mode]]
- [[package:graphql-ts-mode]] if [[module:+tree-sitter]]
- [[package:graphql-doc]]
