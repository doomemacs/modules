...
** Module flags
- +lsp ::
  Enable LSP support for ~scala-mode~. Requires [[module::tools lsp]] and a langserver
  (supports metals).
- +tree-sitter ::
...
- [[package:sbt-mode]]
- [[package:scala-mode]]
- [[package:scala-ts-mode]] if [[module:+tree-sitter]]
- [[package:lsp-metals]] if [[module:+lsp]]
...
Formatting is handled using the [[module::editor format]] module via [[https://scalameta.org/scalafmt/docs/installation.html#cli][scalafmt]].
