...
- Auto-formatting on save (~gofmt~) (requires [[module::editor format +onsave]])
...
** Module flags
- +lsp ::
  Enable LSP support for ~go-mode~. Requires [[module::tools lsp]] and a langserver
...
** Packages
- [[package:company-go]] if [[module::completion company]] (DEPRECATED)
- [[package:flycheck-golangci-lint]] if [[module::checkers syntax]]
- [[package:go-eldoc]]
- [[package:go-gen-test]]
- [[package:go-mode]]
- [[package:gorepl-mode]]
