...
- +lsp ::
  ...
  Requires [[module::tools lsp]] and a langserver (supports [[https://github.com/AdaCore/ada_language_server][ada_language_server]]).
- +tree-sitter ::
  Leverages tree-sitter for better syntax highlighting and structural text
  editing. Requires [[module::tools tree-sitter]] and Emacs 29.1+.

** Packages
- [[package:ada-mode]]
- [[package:ada-ts-mode]] if [[module:+tree-sitter]]
- [[package:gpr-mode]]
- [[package:gpr-ts-mode]] if [[module:+tree-sitter]]
