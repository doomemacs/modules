...
- +lsp ::
  ...
  [[doom-module::tools lsp]] and a langserver (e.g. [[https://github.com/dotnet/roslyn/tree/main/src/LanguageServer/Microsoft.CodeAnalysis.LanguageServer][roslyn-language-server]] or
...
- csharpier (if [[doom-module::editor format]])
