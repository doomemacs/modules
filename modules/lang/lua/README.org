...
- +lsp ::
  Enable LSP support for ~lua-mode~. Requires [[module::tools lsp]] and a langserver
  (supports EmmyLua, lua-language-server, and lua-lsp).
- +tree-sitter ::
  Leverages tree-sitter for better syntax highlighting and structural text
  editing. Requires Emacs 30.1+ and [[module::tools tree-sitter]]. Only
...
- [[package:fennel-mode]] if [[module:+fennel]]
- [[package:lua-mode]]
- if [[module:+moonscript]]
  - [[package:flycheck-moonscript]] if [[module::checkers syntax]]
  - [[package:moonscript-mode]]
...
LSP server support depends on which flavor of the [[module::tools lsp]] module you have
installed ([[pkg:eglot]] or [[pkg:lsp-mode]]).
...
Formatting is handled using the [[module::editor format]] module via [[https://github.com/JohnnyMorganz/StyLua#installation][Stylua]].
...
- lua-lsp-dir :: This must be set when using [[module:+lsp]] and using [[https://github.com/sumneko/lua-language-server][lua-language-server]].
