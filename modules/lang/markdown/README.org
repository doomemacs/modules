...
** Module flags
- +lsp ::
  Enable an LSP hook for ~markdown-mode~, ~gfm-mode~, and ~markdown-ts-mode~. Requires
  [[module::tools lsp]] and a language server (e.g. unified-language-server,
  remark-language-server, marksman, vscode-markdown-language-server).
- +grip ::
...
- +tree-sitter ::
  ...
  editing. Requires [[module::tools tree-sitter]]. Tree-sitter support for
  Markdown is rudimentary in Emacs 30 or older. Upgrade to 31 for better
  support.

** Packages
- [[package:edit-indirect]]
- [[package:evil-markdown]] if [[module::editor evil +everywhere]]
- [[package:grip-mode]] if [[module:+grip]]
- [[package:markdown-ts-mode]] if [[module:+tree-sitter]] (and Emacs <31)
- [[package:markdown-mode]]
- [[package:markdown-toc]]

** Hacks
- [[package:flyspell]] has been configured not to spell check in code blocks, links, HTML
  tags or references.
...
- A linter (requires [[module::checkers syntax]])
...
Alternatively, you can use ~grip-mode~ through [[module:+grip]].
