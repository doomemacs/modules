...
** Auto-formatting
When [[doom-module::editor format]] is enabled and [[https://github.com/fortran-lang/fprettify][fprettify]] is installed, buffers can be
formatted with [[fn:apheleia-format-buffer]].

Enable [[doom-module::editor format +onsave]] to format the buffer on save. See below for advanced configuration.
