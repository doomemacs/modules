...
- ctags-based code completion ([[pkg:company-php]] and [[pkg:phpctags]])
- eldoc support ([[pkg:ac-php]] and [[pkg:php-extras]])
- REPL ([[pkg:psysh]])
- Code refactoring commands ([[minor:php-refactor-mode]])
- Unit-test commands (~phpunit~)
- Support for Laravel and Composer projects (with project-specific snippets)
- LSP support (via the [[module:+lsp]] flag)
...
- +lsp ::
  Enable LSP support for [[major:php-mode]]. Requires [[module::tools lsp]] and a langserver
  (supports [[https://emacs-lsp.github.io/lsp-mode/page/lsp-phpactor/][phpactor]], [[https://emacs-lsp.github.io/lsp-mode/page/lsp-intelephense/][intelephense]], [[https://emacs-lsp.github.io/lsp-mode/page/lsp-serenata/][serenata]], [[https://emacs-lsp.github.io/lsp-mode/page/lsp-php/][php-language-server]]).
- +tree-sitter ::
  Leverages tree-sitter for better syntax highlighting and structural text
  editing. Requires [[module::tools tree-sitter]] and Emacs 30.1+.

** Packages
- [[package:async]]
- [[package:hack-mode]] if [[module:+hack]]
- [[package:psysh]]
- [[package:php-extras]]
- [[package:php-mode]]
...
If [[module:+lsp]] is enabled, you'll also need one of these LSP servers:
...
- [[https://emacs-lsp.github.io/lsp-mode/page/lsp-intelephense/][Intelephense]] *(recommended)*
...
You may also need to regenerate your envvar file by running ~$ doom sync --env~ on
the command line.
...
+ [[cmd:phpunit-current-project]] :: Launch all tests for the project
+ [[cmd:phpunit-current-class]] :: Launch all tests for the current class/fixture
+ [[cmd:phpunit-current-test]] :: Launch the current test at point
...
These are all executed via [[kbd:][M-x]] too.
...
This mode is disabled by default, to opt-in set [[var:+php-run-tests-in-docker]] to
~t~ in your config.

If you wish to specify a different container, modify the
[[var:+php-default-docker-container]] variable (ideally inside a ~.dir-locals.el~
file):
#+begin_src emacs-lisp
