...
- +lsp ::
  Enable LSP support for ~dart-mode~. Requires [[module::tools lsp]] and a langserver
  (supports flutter).
- +tree-sitter ::
...
** Packages
- [[package:dart-mode]]
- [[package:dart-ts-mode]] if [[module:+tree-sitter]]
- [[package:flutter.el]]
- [[package:hover.el]]
...
- Syntax highlighting and formatting for ~.dart~ files provided by LSP or [[module::editor format]].
- Auto import.
- Widget guide lines for Flutter.
- Closing labels for constructors.
- Run tests interactively.
- Outline support via [[pkg:lsp-treemacs]].
