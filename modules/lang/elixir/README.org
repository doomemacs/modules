...
** Module flags
- +lsp ::
  Enable LSP support for ~elixir-mode~. Requires [[module::tools lsp]] and a
...
- [[package:elixir-mode]]
- [[package:exunit]]
- [[package:flycheck-credo]] if [[module::checkers syntax]]
...
To add LSP support, install [[https://github.com/JakeBecker/elixir-ls/][elixir-ls]] and enable [[module::tools lsp]].
...
- Code completion ([[module::completion company]])
- Documentation lookup ([[module::tools lookup]])
- Mix integration
- Phoenix support
- ~iex~ integration ([[module::tools eval]])
- Syntax checking ([[module::checkers syntax]], using [[pkg:flycheck-credo]])
- Formatting for elixir files provided by [[module::editor format]].
