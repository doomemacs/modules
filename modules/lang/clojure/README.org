...
- Linting (~clj-kondo~), requires [[module::checkers syntax]]
- LSP support (~clojure-lsp~), required [[module:+lsp]]
...
** Module flags
- +lsp ::
  Enable LSP support for ~clojure-mode~ (alongside Cider). Requires [[module::tools lsp]]
  and a langserver (supports [[https://clojure-lsp.io/][clojure-lsp]]).
- +tree-sitter ::
  Leverages tree-sitter for better syntax highlighting and structural text
  editing. Requires [[module::tools tree-sitter]] and Emacs 30.1 or newer.

** Packages
- [[package:cider]]
- [[package:clj-refactor]]
- [[package:clojure-mode]]
- [[package:clojure-ts-mode]] if [[module:+tree-sitter]]
- [[package:flycheck-clj-kondo]] if [[module::checkers syntax]]
- [[package:jet]]
- [[package:neil]]
...
- [[https://github.com/borkdude/clj-kondo][clj-kondo]], for linting code (if [[module::checkers syntax]])
- [[https://clojure-lsp.github.io/clojure-lsp/][clojure-lsp]], for LSP support (if [[module:+lsp]])
...
- [[https://github.com/weavejester/cljfmt][cljfmt]], for formatting code (if [[module::editor format]])
...
** Search/navigation
Some useful bindings for navigating around namespaces and symbols. When using [[module:+lsp]], the bindings in [[module::tools lsp]] are supported.
