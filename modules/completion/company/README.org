...
#+begin_quote warning
*This module is deprecated* in favor of the [[module::completion corfu]] module. This module
will be in maintenance mode until it is eventually removed. Consider switching
to the Corfu module instead.
#+end_quote

* Description :unfold:
This module provides code completion, powered by [[https://github.com/company-mode/company-mode][company-mode]]. Many of Doom's
[[module::lang]] modules require it for "intellisense" functionality.
...
** Packages
- [[package:company-box]] if [[module:+childframe]]
