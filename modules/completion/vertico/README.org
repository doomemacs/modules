...
like [[pkg:ivy]] and [[pkg:helm]] do. The primary packages are:
...
** Packages
- [[package:nerd-icons-completion]] if [[module:+icons]]
- [[package:consult]]
- [[package:consult-flycheck]] if [[module::checkers syntax]]
- [[package:embark]]
- [[package:embark-consult]]
- [[package:marginalia]]
- [[package:orderless]]
- [[package:vertico]]
- [[package:vertico-posframe]] if [[module:+childframe]]
- [[package:wgrep]]
...
[[asset:https://assets.doomemacs.org/completion/vertico/projectile.png]]
...
[[asset:https://assets.doomemacs.org/completion/vertico/search.png]]
...
(alternatively [[kbd:ZZ]] and [[kbd:ZQ]], for evil users). It uses [[pkg:wgrep]] for grep searches,
[[pkg:wdired]] for file searches, and =occur= for buffer searches.

[[asset:https://assets.doomemacs.org/completion/vertico/search-replace.png]]
...
[[asset:https://assets.doomemacs.org/completion/vertico/buffer-search.png]]
...
filtered with Emacs instead (and can be filtered using [[pkg:orderless]], for example).
