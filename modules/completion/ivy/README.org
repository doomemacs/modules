...
#+begin_quote warning
*This module is deprecated* in favor of the [[module::completion vertico]] module. This
module will be in maintenance mode until it is eventually removed. Consider
switching to the Vertico module instead.
#+end_quote
...
** Packages
- [[package:nerd-icons-ivy]]* if [[module:+icons]]
- [[package:amx]]
- [[package:counsel]]
- [[package:counsel-projectile]]
- [[package:flx]]* if [[module:+fuzzy]]
- [[package:ivy]]
- [[package:ivy-hydra]]
- [[package:ivy-posframe]]* if [[module:+childframe]]
- [[package:ivy-rich]]
- [[package:prescient]]* if [[module:+prescient]]
- [[package:swiper]]
- [[package:wgrep]]
...
[[pkg:ivy]] is a /large/ framework for completing things. Covering all its features is
...
Command-T, this module provides similar functionality by bringing [[pkg:projectile]] and
[[pkg:ivy]] together.

[[asset:https://assets.doomemacs.org/completion/ivy/projectile.png]]
...
[[asset:https://assets.doomemacs.org/completion/ivy/search.png]]
...
[[assets:https://assets.doomemacs.org/completion/ivy/search-replace.png]]

** In-buffer searching
The [[pkg:swiper]] package provides an interactive buffer search powered by ivy. It
can be invoked with:
...
[[assets:https://assets.doomemacs.org/completion/ivy/swiper.png]]
